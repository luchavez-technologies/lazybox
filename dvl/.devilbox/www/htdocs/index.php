...
$php_services = ['Php82', 'Php81', 'Php80', 'Php74', 'Php73', 'Php72', 'Php71', 'Php70', 'Php56', 'Php55', 'Php54'];
$addon_services = ['Minio', 'Mailhog', 'Ngrok', 'Soketi', 'Meilisearch'];
...
<div class="container">
		...
		<div class="col-md-4 col-sm-4 col-xs-12 col-margin">
			<div class="dash-box">
				...
				<div class="dash-box-body">
					<strong>Devilbox</strong> <?php echo $GLOBALS['DEVILBOX_VERSION']; ?>
					<small>(<?php echo $GLOBALS['DEVILBOX_DATE']; ?>)</small>
				</div>
			</div>
		</div>
		...
		<div class="col-md-4 col-sm-4 col-xs-12 col-margin">
			<div class="dash-box">
				...
				<div class="dash-box-body">
					<div class="meter">
						<span
							style="color:black; width: <?php echo $HEALTH_PERCENT; ?>%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $HEALTH_PERCENT; ?>%</span>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="row">
		...
		<div class="col-md-4 col-sm-4 col-xs-12 col-margin">
			<div class="dash-box">
				<div class="dash-box-head"><i class="fa fa-database" aria-hidden="true"></i> NoSQL Stack</div>
				<div class="dash-box-body">
					<div class="row">
						<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-xs-4" style="margin-bottom:15px;">
	...
	<div class="row">
		<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 col-margin">
			<div class="dash-box">
				<div class="dash-box-head"><i class="fa fa-info-circle" aria-hidden="true"></i> Available CLI Tools
				</div>
				<div class="dash-box-body">
					<p><small>You can also enter the php container via <code style="background-color:#3d3d3d;">./shell.sh</code>
							and use the following cli tools:</small></p>
		...
		<div class="col-md-4 col-sm-4 col-xs-12 col-margin">
			<div class="row">
				<div class="col-12 col-margin">
					<div class="dash-box">
						<div class="dash-box-head"><i class="fa fa-info-circle" aria-hidden="true"></i> Add-ons</div>
						<div class="dash-box-body">
							<div class="row">
								<?php foreach ($addon_services as $service): ?>
									<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-xs-4"
										 style="margin-bottom:15px;">
										<?php echo loadClass('Html')->getCirle($service); ?>
									</div>
								<?php endforeach; ?>
							</div>
						</div>
				...
				<div class="col-12 col-margin">
					<div class="dash-box">
						<div class="dash-box-head"><i class="fa fa-code" aria-hidden="true"></i> PHP Containers</div>
						<div class="dash-box-body">
							<div class="row">
								<?php foreach ($php_services as $service): ?>
									<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-xs-4"
										 style="margin-bottom:15px;">
										<?php echo loadClass('Html')->getCirle($service); ?>
									</div>
		...
		<div class="col-md-4 col-sm-4 col-xs-12 col-margin">
			<div class="dash-box">
				<div class="dash-box-head"><i class="fa fa-info-circle" aria-hidden="true"></i> PHP Container Status
				</div>
				<div class="dash-box-body">
					...
					<table class="table table-striped table-hover table-bordered table-sm font-small">
						...
						<tr>
							<th>DNS</th>
							<td><?php if ($avail_dns): ?>Enabled<?php else: ?><span
									class="text-danger">Offline</span><?php endif; ?></td>
						</tr>
						<tr>
							<th>Postfix</th>
					...
					<p><small>The PHP container can connect to the following services via the specified hostnames and IP
							addresses.</small></p>
					<table class="table table-striped table-hover table-bordered table-sm font-small">
						<thead class="thead-inverse">
						<tr>
						...
						<?php foreach ($connection as $name => $docker): ?>
							<tr>
							<th rowspan="<?php echo count($docker); ?>" class="align-middle"><?php echo $name; ?>
								connect
							</th>
							<?php $i = 1;
							foreach ($docker as $conn): ?>
						...
						<div class="container">
							<table class="table table-striped table-hover table-bordered table-sm font-small">
								...
								<tr>
									<th>httpd</th>
									<td>
										<?php echo loadClass('Helper')->getEnv('LOCAL_LISTEN_ADDR') . loadClass('Helper')->getEnv('HOST_PORT_HTTPD'); ?>
										<br/>
								...
								<?php if ($avail_dns): ?>
									<tr>
										<th>bind</th>
										<td>
											<?php echo loadClass('Helper')->getEnv('LOCAL_LISTEN_ADDR') . loadClass('Helper')->getEnv('HOST_PORT_BIND'); ?>
											/tcp<br/>
											<?php echo loadClass('Helper')->getEnv('LOCAL_LISTEN_ADDR') . loadClass('Helper')->getEnv('HOST_PORT_BIND'); ?>
											/udp
										</td>
							...
							<table class="table table-striped table-hover table-bordered table-sm font-small"
								...
								<?php if ($avail_memcd): ?>
									<tr>
										<th>memcached</th>
										<td>
											./log/memcached-<?php echo loadClass('Helper')->getEnv('MEMCD_SERVER'); ?></td>
