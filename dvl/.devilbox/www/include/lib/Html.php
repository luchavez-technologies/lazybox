...
class Html
{
	...
	public function getHead($font_awesome = false)
	{
		...
		$workspace = strtoupper(loadClass('Helper')->getEnv('HOST_PATH_CURRENT_WORKSPACE'));
		...
		$html = <<<HTML
			<nav class="navbar navbar-toggleable-md navbar-inverse bg-inverse">
				...
				<a class="navbar-brand" href="/index.php">
					<img src="/assets/img/logo.png" width="30" height="30" class="d-inline-block align-top" alt="">lazybox
				</a>
			...
			<div class="row">
				<div class="col-12">
					<div class="alert alert-info col-12" role="alert">
						<h1 class="text-center text-uppercase">🐳 {$workspace}</h1>
					</div>
				</div>
			</div>
HTML;
			...
			<nav class="navbar navbar-toggleable-md navbar-inverse bg-inverse footer">
				<div class="container justify-content-end">
					<ul class="nav navbar-nav">
						...
						<li class="nav-item"><a class="nav-link" target="_blank" href="https://github.com/cytopia/devilbox"><code>Github (Devilbox)</code></a></li>
						<li class="nav-item"><a class="nav-link" target="_blank" href="https://github.com/luchavez-technologies/lazybox"><code>Github (Lazybox)</code></a></li>
...
HTML;
	...
	public function getServiceCard(string $service, string $display_name, string|null $url = null, array $vars = []): string
	{
		$badge = $this->getServiceBadge($service, $url);

		$rows = $this->getEnvVarsAsRow($vars);

		return <<<HTML
		<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 col-margin">
			<div class="dash-box">
				<div class="dash-box-head">$display_name$badge</div>
...
HTML;
	...
	public function getServiceBadge(string $service, string|null $url = null): string
	{
		...
		return <<<HTML
		<$tag $href class="badge badge-$color float-right">$status</$tag></>
HTML;
